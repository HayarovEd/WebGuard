...
import static org.squareup.okhttp.internal.Util.checkOffsetAndCount;
import static org.squareup.okhttp.internal.http.StatusLine.HTTP_CONTINUE;
import static org.squareup.okhttp.internal.http.Transport.DISCARD_STREAM_TIMEOUT_MILLIS;
...
public final class HttpConnection {
  ...
  public void closeOnIdle() throws IOException {
    ...
    if (state == STATE_IDLE) {
      ...
      VpnSocketEnumerator.unregisterSocket(connection.getSocket());
    }
  }
