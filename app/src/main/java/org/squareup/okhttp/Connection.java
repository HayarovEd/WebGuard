...
import org.squareup.okhttp.internal.http.HttpConnection;
import org.squareup.okhttp.internal.http.HttpEngine;
import org.squareup.okhttp.internal.http.HttpTransport;
import org.squareup.okhttp.internal.http.OkHeaders;
import org.squareup.okhttp.internal.http.SpdyTransport;
import org.squareup.okhttp.internal.http.Transport;
...
public final class Connection {
  ...
  void closeIfOwnedBy(Object owner) throws IOException {
    ...
    socket.close();
    VpnSocketEnumerator.unregisterSocket(socket);
  }
  ...
  void connect(int connectTimeout, int readTimeout, int writeTimeout, Request tunnelRequest)
    ...
    VpnSocketEnumerator.registerSocket(socket);
