...
import org.squareup.okhttp.internal.http.AuthenticatorAdapter;
import org.squareup.okhttp.internal.http.HttpEngine;
import org.squareup.okhttp.internal.http.Transport;
import org.squareup.okhttp.internal.tls.OkHostnameVerifier;
...
public class OkHttpClient implements Cloneable {
  ...
  /**
   * Sets the HTTP host ip that will be used by connections created by this
   * client.
   */
  public final OkHttpClient setHostIp(String ip) {
    this.hostIp = ip;
    return this;
  }
