...
//	  }
	...
	public static long	  getLibsVersion () { return nf71(); }
	public static String  getString () { return nf72(); }
	public static void	  dumpProcs () { nf73(); }
////	public static native void	 testNotify ();
	public static void	  testNetlink () { nf74(); }
	...
	public static String[] getNamesFromUid (int uid, int dummy) { return nf50(uid); }

	// exit ;)
	public static void exit (int code) { nf51(code); }
	...
	public static int	   getnameinfo (String ip, String[] names) { return nf21(ip, names); }
	...
	public static boolean  netlinkIsWork () { return nf24(); }
	...
	public static String   ipToString (byte[] ip, int port) { return nf27(ip, port); }

	//
	public static void	   socketPrintInfo		(int fd) { nf28(fd); }
	...
	public static boolean  socketEnableKA		(int fd, boolean enable) { return nf30(fd, enable); }

	// check if socket have unsended data
	public static boolean  socketHaveDataToSend (int fd) { return nf31(fd); }

	// try to send data through socket with flush (return false if no data)
	public static boolean  socketSendDataForce	(int fd, byte[] data) { return nf32(fd, data); }

	// return names of all or active (up == true) network interfaces (or null)
	public static String[] getIfNames	  (boolean up) { return nf33(up); }
	...
	public static void		  fileSetBlocking (int fd, boolean enable) { nf10(fd, enable); }

	// close file fd, returns zero on success
	public static int		  fileClose (int fd) { return nf11(fd); }
...
//	  public static native byte[]	   sha1File (String filepath);
	...
	public static boolean	  zipFreeData (ByteBuffer data) { return nf02(data); }


	/* --- text functions --- */


	public static String  asciiToLower (String str) { return nf81(str); }
	public static boolean asciiStartsWith (String start, String str) { return nf82(start, str); }
	public static boolean asciiEndsWith (String end, String str) { return nf83(end, str); }
	public static int	  asciiIndexOf (String search, String str) { return nf84(search, 0, str); }
	public static int	  asciiIndexOf (String search, int from, String str) { return nf84(search, from, str); }
	...
	public static int	  signalHandlerSet (int signal) { return nf61(signal); }

	// send signal to our process (SIGHUP 1)
	public static int	  signalSendSelf (int signal) { return nf62(signal); }

	// get current thread native id
	public static long	  threadGetSelfId () { return nf63(); }

	// send signal to thread (see threadGetSelfId) and return 0 on success
	public static int	  threadSendSignal (long id, int signal) { return nf64(id, signal); }
