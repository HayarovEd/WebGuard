...
public class EthernetFrame
{
	 ...
	 * @param size
	 */
	public void createIPPacketBytes(int size)
	{
	...
	public void createIPPacketBytes(byte[] ipdata)
	{
		createIPPacketBytes(ipdata.length);
		System.arraycopy(ipdata, 0, myPacket, ETHERNET_HEADER_LENGTH, ipdata.length);
	}
}
