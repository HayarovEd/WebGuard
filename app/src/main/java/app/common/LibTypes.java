...
//	  }
	...
	public static ByteBuffer intSetCreate	()							 { return tf01(); }
	public static void		 intSetDelete	(ByteBuffer set)			 { tf02(set); }
	public static long		 intSetSize		(ByteBuffer set)			 { return tf03(set); }
	public static boolean	 intSetContains (ByteBuffer set, int value)  { return tf04(set, value); }
	// return true if the set was modified by operation
	public static boolean	 intSetAdd		(ByteBuffer set, int value)  { return tf05(set, value); }
