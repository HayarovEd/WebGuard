...
public class DNSRequest
{
				...
				if (len < 128)
				{
					...
					for (int c = 0; c < len; c++)
					{
						if (Settings.DEBUG)
							...
							if (off + c > buf.length - 1) L.e(Settings.TAG_DNSREQUEST, "Error in parse! ", sb.toString());
	...
	{
		DNSResponse response = new DNSResponse(transactionID, domains, packet.dstIp, packet.dstPort,
