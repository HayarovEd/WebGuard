...
/*
	public void notifyUdpTimeout()
	{
		if (worker != null)
		{
			worker.notifyUdpTimeout();
		}
	}
*/
						...
						IPacketLogger logger, IHasherListener hasherListener, IUserNotifier notifier)
	{
		...
		{
			worker.stop();
			try { worker.ensureStopped(); } catch (NullPointerException e) {} // TODO XXX because stop()->ProxyBase.setWorker(null)
			worker = null;
		}
