...
//	  }
	...
	public static String recordTypeToString (int type)
	{
		switch (type)
		{
			case RECORD_TYPE_TEST:		 return "TEST";
			case RECORD_TYPE_WHITE:		 return "WHITE";
			//
			case RECORD_TYPE_CHARGEABLE: return "CHARGEABLE";
			case RECORD_TYPE_FRAUD:		 return "FRAUD";
			case RECORD_TYPE_MALWARE:	 return "MALWARE";
			//
			case RECORD_TYPE_ADS:		 return "ADS";
			case RECORD_TYPE_ADS_TPARTY: return "ADS_TPARTY";
			case RECORD_TYPE_ADS_OK:	 return "ADS_OK";
			//
			case RECORD_TYPE_SOCIAL_OTHER:	  return "SOCIAL_OTHER";
			case RECORD_TYPE_SOCIAL_GPLUS:	  return "SOCIAL_GPLUS";
			case RECORD_TYPE_SOCIAL_VK:		  return "SOCIAL_VK";
			case RECORD_TYPE_SOCIAL_FB:		  return "SOCIAL_FB";
			case RECORD_TYPE_SOCIAL_TWI:	  return "SOCIAL_TWI";
			case RECORD_TYPE_SOCIAL_ODNKLASS: return "SOCIAL_ODNKLASS";
			case RECORD_TYPE_SOCIAL_MAILRU:   return "SOCIAL_MAILRU";
			case RECORD_TYPE_SOCIAL_LJ:		  return "SOCIAL_LJ";
			case RECORD_TYPE_SOCIAL_LINKEDIN: return "SOCIAL_LINKEDIN";
			case RECORD_TYPE_SOCIAL_MOIKRUG:  return "SOCIAL_MOIKRUG";
			//
			case RECORD_TYPE_CLEAN:		 return "CLEAN";
	...
	public static String binaryTypeToString (int type)
	{
		switch (type)
		{
			case BINARY_TYPE_ZIP:	return "ZIP";
			case BINARY_TYPE_TAR:	return "TAR";
			case BINARY_TYPE_GZIP:	return "GZIP";
			case BINARY_TYPE_BZIP2: return "BZIP2";
			case BINARY_TYPE_RAR4:	return "RAR4";
			case BINARY_TYPE_RAR5:	return "RAR5";
			case BINARY_TYPE_ZIP7:	return "ZIP7";
			case BINARY_TYPE_CAB:	return "CAB";
			case BINARY_TYPE_XZ:	return "XZ";
			//
			case BINARY_TYPE_ELF32:  return "ELF32";
			case BINARY_TYPE_ELF64:  return "ELF64";
			case BINARY_TYPE_DEX035: return "DEX035";
			//
			default:				return "UNKNOWN";
		}
	}
	...
	public static boolean	 unloadDB (ByteBuffer db) { return sf02(db); }

	// check that database loaded correctly
	public static boolean	 dbIsLoaded			  (ByteBuffer db) { return sf03(db); }

	// get database version, number of records in database, and compare records types
	public static int		 dbGetVersion		  (ByteBuffer db) { return sf04(db); }
	public static long		 dbGetRecordsNumber   (ByteBuffer db) { return sf05(db); }
	 ...
	 * type == RECORD_TYPE_*
	 */
	public static boolean	 recordTypeIsDangerous (int type) { return sf07(type); }
	public static boolean	 recordTypeIsAds	   (int type) { return sf08(type); }
	public static boolean	 recordTypeIsSocial    (int type) { return sf09(type); }
	 ...
	 */
	public static boolean	 binaryTypeIsArchive	(int type) { return sf13(type); }
	public static boolean	 binaryTypeIsExecutable (int type) { return sf14(type); }
