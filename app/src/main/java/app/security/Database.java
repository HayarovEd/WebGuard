...
public class Database
{
	...
	public static boolean init()
	{
		synchronized (lock)
		{
			...
			Statistics.addLog(Settings.LOG_DB_COPY_ERR);
	...
	public static boolean distribHaveNewer()
	{
		int dVer = 0;
		int cVer = 0;
		try { dVer = Integer.parseInt(getDistribVersion()); } catch (NumberFormatException e) { }
		try { cVer = Integer.parseInt(getCurrentVersion()); } catch (NumberFormatException e) { }
